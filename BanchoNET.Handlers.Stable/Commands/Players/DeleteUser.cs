...
public partial class CommandProcessor
{
    ...
    {
        if (args.Length == 0)
            return $"No parameters provided. Syntax: {Commands.CommandProcessor.Prefix}delete_user <delete_scores> [<force>] \"<username>\"";
        
        if (args.Length < 2)
            return $"Invalid number of parameters provided. Syntax: {Commands.CommandProcessor.Prefix}delete_user <delete_scores> [<force>] \"<username>\"";
