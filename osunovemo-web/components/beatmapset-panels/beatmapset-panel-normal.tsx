...
export function BeatmapsetPanelNormal({
    beatmapset,
    className,
                    ...
                    <div className="pointer-events-none relative z-10 flex h-25 w-full md:h-full">
                        ...
                        <div
                            className={cn(
                                ...
                                "bg-transparent px-2.5 pt-1 pb-1.5 md:bg-linear-to-r md:from-osu-b2 md:to-osu-b2/70",
                        ...
                        >
                            ...
                            <div className="relative flex items-baseline font-bold text-osu-c2 md:hidden">
                                <div className="min-w-0 truncate">{beatmapset.source || "\u00A0"}</div>
                            </div>

                            <div className="relative mt-auto flex items-baseline font-semibold text-osu-c2">
                            ...
                            <div
                                className={cn(
                                    "grid w-max max-w-full grid-flow-col auto-cols-max gap-x-2.5 gap-y-0 overflow-hidden whitespace-nowrap",
                                    "opacity-100 md:mb-0.5 md:opacity-0 md:transition-opacity md:duration-150",
                                    "md:group-hover/panel:opacity-100 md:group-focus-within/panel:opacity-100",
