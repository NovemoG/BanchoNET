...
namespace BanchoNET.Core.Migrations
{
    ...
    [Migration("20260420224306_NewMessageModels")]
    partial class NewMessageModels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChannelDtoPlayerDto", b =>
                {
                    b.Property<int>("PlayersId")
                        .HasColumnType("integer");

                    b.Property<long>("PmChannelsId")
                        .HasColumnType("bigint");

                    b.HasKey("PlayersId", "PmChannelsId");

                    b.HasIndex("PmChannelsId");

                    b.ToTable("ChannelDtoPlayerDto");
                });
            ...
            modelBuilder.Entity("ChannelDtoPlayerDto", b =>
                {
                    ...
                    b.HasOne("BanchoNET.Core.Models.Dtos.ChannelDto", null)
                        .WithMany()
                        .HasForeignKey("PmChannelsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
